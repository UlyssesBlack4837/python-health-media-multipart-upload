...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of storage.bucket.create, storage.multipart.create, storage.multipart.presign_part, storage.multipart.complete) and reuse it from your own code.
